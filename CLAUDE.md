...
CI (`.github/workflows/ci.yml`): lint + typecheck + tests + validate + build en cada push; deploy a GitHub Pages en merge a `main`. Producción: https://dfcaballero-la.github.io/mi-album/
